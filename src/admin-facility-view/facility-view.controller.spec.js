...
describe('FacilityViewController', function() {
    ...
    beforeEach(function() {
        ...
        inject(function($injector) {
            ...
            this.FacilityOperatorDataBuilder = $injector.get(
        ...
        this.facility = new this.FacilityDataBuilder().withFacilityType(
            this.facilityTypes[0]
        )
            .build();
    ...
    describe('onInit', function() {
        ...
        it('should expose enableValue', function() {
            expect(this.vm.enableValue).toEqual(
                this.facility.enableLocationManagement
            );
        });

        it('should expose facilityID', function() {
            expect(this.vm.facilityId).toEqual(this.facility.id);
        });
        ...
        it('should expose supported programs list as empty list if undefined',
            function() {
    ...
    describe('saveFacility', function() {
        ...
        it('should close loading modal and show error notification after save fails',
            function() {
                this.FacilityRepository.prototype.update.andReturn(
                    this.$q.reject()
                );
                this.vm.saveFacilityDetails();
                this.$rootScope.$apply();
