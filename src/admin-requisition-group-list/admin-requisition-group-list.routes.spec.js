...
describe('openlmis.administration.requisitionGroupList', function() {
    ...
    beforeEach(function() {
        ...
        inject(function($injector) {
            ...
            this.RequisitionGroupDataBuilder = $injector.get(
                'RequisitionGroupDataBuilder'
            );
            ...
            this.FacilityResourceOrigin = $injector.get('FacilityResourceOrigin');
        ...
        spyOn(this.requisitionGroupService, 'search')
            .andReturn(this.$q.resolve(new this.PageDataBuilder()
                ...
                .build()));
        spyOn(this.programService, 'getAll').andReturn(
            this.$q.resolve(this.programs)
        );
        spyOn(this.geographicZoneService, 'getAll')
            .andReturn(this.$q.resolve(new this.PageDataBuilder()
                .withContent(this.geographicZones)
                .build()));
        spyOn(this.FacilityResourceOrigin.prototype, 'query').andReturn(
            this.$q.resolve(
    ...
    describe('state', function() {
        ...
        it('should be available under "/administration/requisitionGroups" URI',
            function() {
                expect(this.$state.current.name).not.toEqual(
                    'openlmis.administration.requisitionGroupList'
                );

                this.goToUrl('/administration/requisitionGroups');

                expect(this.$state.current.name).toEqual(
                    'openlmis.administration.requisitionGroupList'
                );
            });
        ...
        it('should use template', function() {
            ...
            expect(this.$templateCache.get)
                .toHaveBeenCalledWith(
                    'admin-requisition-group-list/requisition-group-list.html'
                );
        });
        ...
        it('should resolve geographicZones', function() {
            ...
            expect(this.getResolvedValue('geographicZones')).toEqual(
                this.geographicZones
            );
        ...
        it('should resolve facilitiesMap', function() {
            ...
            expect(this.FacilityResourceOrigin.prototype.query).toHaveBeenCalledWith({
        ...
        it('should not resolve facilitiesMap if requisition groups is empty',
            function() {
                ...
                expect(
                    this.FacilityResourceOrigin.prototype.query
