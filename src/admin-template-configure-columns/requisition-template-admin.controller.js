...
(function() {
    ...
    function RequisitionTemplateAdminController($state, template, program, tags, notificationService, messageService,
        ...
        vm.isSuggestedQuantity = isSuggestedQuantity;
        // #517: ends here
         ...
         * @ngdoc method
         * @methodOf admin-template-configure-columns.controller:RequisitionTemplateAdminController
         * @name isSuggestedQuantity
         *
         * @description
         * Determines whether displayed column is suggested quantity.
         *
         * @param  {Object}  column Column
         * @return {Boolean}        True if column name is suggestedQuantity.
         */
        function isSuggestedQuantity(column) {
