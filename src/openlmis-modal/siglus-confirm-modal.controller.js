...
(function() {
    ...
    controller.$inject = [
        'className', 'message', 'firstConfirmMessage', 'secondConfirmMessage', 'cancelMessage', 'titleMessage',
        'confirmDeferred', 'messageService', 'modalDeferred'
    ];

    function controller(className, message, firstConfirmMessage, secondConfirmMessage, cancelMessage, titleMessage,
                        confirmDeferred, messageService, modalDeferred) {
        var vm = this;
         ...
         * @propertyOf openlmis-modal.controller:SiglusConfirmModalController
         * @type {String}
         * @name firstConfirmMessage
         *
         * @description
         * The message to be displayed on the first confirmation button.
         */
        vm.firstConfirmMessage = undefined;

        /**
         * @ngdoc property
         * @propertyOf openlmis-modal.controller:SiglusConfirmModalController
         * @type {String}
         * @name secondConfirmMessage
         *
         * @description
         * The message to be displayed on the second confirmation button.
         */
        vm.secondConfirmMessage = undefined;
        ...
        function onInit() {
            ...
            vm.firstConfirmMessage = firstConfirmMessage;
            vm.secondConfirmMessage = secondConfirmMessage;
