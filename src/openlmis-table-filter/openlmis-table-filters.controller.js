...
(function() {
    ...
    function OpenlmisTableFiltersController($scope, $compile, $timeout) {
        var form, forms, submitButton,
            ...
            filterButton, ngModels, ngModelValues,
            SUBMIT_ELEMENT = '[type="submit"]',
            // SIGLUS-REFACTOR: starts here
            CANCEL_ELEMENT = '[id="close-filters"]',
            // SIGLUS-REFACTOR: ends here
        ...
        // SIGLUS-REFACTOR: starts here
        function replaceCancelButtonIfElementContainsCancelButton(element) {
            var cancel = element.find(CANCEL_ELEMENT);
            if (cancel.length) {
