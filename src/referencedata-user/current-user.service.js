...
(function() {
    ...
    currentUserInfo.$inject = ['$q', 'UserRepository', 'localStorageService', 'authorizationService'];

    function currentUserInfo($q, UserRepository, localStorageService, authorizationService) {
