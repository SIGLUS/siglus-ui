...
(function() {
    ...
    angular
        ...
        .controller('ARVProductController', controller);
    ...
    function controller(requisitionUtils) {
        ...
        vm.isEmpty = requisitionUtils.isEmpty;

        vm.validateTotalConsumedQuantity = function(item) {
            item.isRequiredTotalConsumedQuantity = true;
        };

        vm.validateTotalLossesAndAdjustments = function(item) {
            item.isRequiredTotalLossesAndAdjustments = true;
        };

        vm.validateStockOnHand = function(item) {
