...
(function() {
    ...
    function siglusConfirmModalService(openlmisModalService, $q) {
         ...
         *
         */
        function confirm(totalPartialLineItems) {
            return makeModal(totalPartialLineItems);
        }

        function makeModal(totalPartialLineItems) {
            var deferred = $q.defer();

            openlmisModalService.createDialog({
                templateUrl: 'shipment-view/siglus-confirm-modal.html',
                controller: 'SiglusConfirmModalController',
                controllerAs: 'vm',
                resolve: {
                    totalPartialLineItems: function() {
