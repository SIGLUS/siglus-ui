...
describe('siglusAnalyticsReportCustomizeMalariaController', function() {
    beforeEach(function() {
        var context = this;
        ...
        this.vm = this.$controller('siglusAnalyticsReportCustomizeMalariaController', {
    ...
    describe('getSubmitDate', function() {
        it('should expose empty string when changeDate is empty', function() {
            var changeDate = null;

            expect(this.vm.getSubmitDate(changeDate)).toEqual('');
        });

        it('should expose empty string when changeDate has value', function() {
            var changeDate = '2022-11-06';

            expect(this.vm.getSubmitDate(changeDate)).toEqual('2022-11-06');
        });
    });

    describe('getApprovedBy', function() {
        it('should expose empty string when signaure is empty object', function() {
            var signaure = {};

            expect(this.vm.getApprovedBy(signaure)).toEqual('');
        });

        it('should return right results when signaure has approve value', function() {
            var signaure = {
                approve: [
                    'test'
                ]
            ...
            expect(this.vm.getApprovedBy(signaure)).toEqual('test');
        });
    });

    describe('getCompletedBy', function() {
        it('should expose empty string when signaure is empty object', function() {
            var signaure = {};
    ...
    describe('getOrderNumber', function() {
        it('should expose empty string when last is undefined', function() {
            var last = undefined;
            var index = 1;

            expect(this.vm.getOrderNumber(index, last)).toEqual(2);
        });

        it('should return right results when last has value', function() {
            var last = 1;
            var index = 1;

            expect(this.vm.getOrderNumber(index, last)).toEqual('');
        });
    });
});