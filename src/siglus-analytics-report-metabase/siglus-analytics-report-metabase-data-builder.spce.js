...
(function() {
    ...
    angular
        ...
        .factory('AnalyticsReportMetabaseDataBuilder', AnalyticsReportMetabaseDataBuilder);

    AnalyticsReportMetabaseDataBuilder.$inject = [];

    function AnalyticsReportMetabaseDataBuilder() {

        AnalyticsReportMetabaseDataBuilder.prototype.build = build;
