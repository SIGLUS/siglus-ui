...
(function() {
   ...
   */
    ...
    function siglusLocationAdjustmentModifyLineItemService(
        $filter, LotRepositoryImpl,
        $q, orderableGroupService, dateUtils
    ) {
        ...
        function mapDataToDisplay(group, isMainGroup, locations, orderableGroups, areaLocationInfo) {
            return _.map(group, function(item) {
                ...
                var location =  item.locationCode ? _.find(areaLocationInfo, function(location) {
