...
(function() {
    ...
    function routes($stateProvider, STOCKMANAGEMENT_RIGHTS, ADJUSTMENT_TYPE) {
        $stateProvider.state('openlmis.locationManagement.adjustment', {
            url: '/adjustment',
            ...
            views: {
                '@openlmis': {
                    controller: 'SiglusLocationAdjustmentController',
                    controllerAs: 'vm',
                    templateUrl: 'siglus-location-adjustment/siglus-location-adjustment.html'
                }
            },
