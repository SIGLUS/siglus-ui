...
describe('openlmis.locationManagement.archivedProductSummaries', function() {
    ...
    it('should be available under \'locationManagement/archivedProductSummaries\'', function() {
        expect($state.current.name).not.toEqual('openlmis.locationManagement.archivedProductSummaries');

        goToUrl('/locationManagement/archivedProduct');

        expect($state.current.name).toEqual('openlmis.locationManagement.archivedProductSummaries');
    });
    ...
    it('should use template', function() {
        ...
        expect($templateCache.get).toHaveBeenCalledWith(
            'siglus-location-archived-product/siglus-location-archived-product-summary-list.html'
        );
    });
    ...
    function loadModules() {
        ...
        module('siglus-location-archived-product', function($provide) {
