...
(function() {
    ...
    siglusLocationIssueCreationController.$inject = ['$stateParams', '$q', '$scope', '$state', 'DRAFT_TYPE',
    ...
    function siglusLocationIssueCreationController($stateParams, $q, $scope, $state, DRAFT_TYPE, draftInfo, facility,
