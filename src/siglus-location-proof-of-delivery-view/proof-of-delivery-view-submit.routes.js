...
(function() {
    ...
    function routes($stateProvider, FULFILLMENT_RIGHTS) {
        ...
        $stateProvider.state('openlmis.orders.podManage.viewWithLocation', {
            label: 'proofOfDeliveryView.viewProofOfDelivery',
            url: '/viewWithLocation?actionType&draftNum&orderId&podId',
            accessRights: [
                    ...
                    resolve: {
                        ...
                        orderLineItems: function(
                            ...
                            return fulfillingLineItemFactory.groupByOrderableForPod(
                                ...
                                return _.sortBy(result, function(product) {
