...
(function() {
     ...
     */
    angular.module('siglus-location-shipment-view')
        .config(config);

    config.$inject = ['$provide'];

    function config($provide) {
        $provide.decorator('SiglusLocationShipmentViewLineItem', decorator);
    }
    ...
    function decorator($delegate) {
        ...
        SiglusLocationShipmentViewLineItem.prototype = $delegate.prototype;
