...
(function() {
    ...
    function ShipmentRepositoryImpl(ShipmentResource, ShipmentDraftResource,
        ...
        function ShipmentRepositoryImpl() {
            ...
            this.siglusShipmentResource = new SigluLocationShipmentResource();
            this.siglusShipmentDraftResource = new SiglusLocationShipmentDraftResource();
            // #287: ends here
        }
            ...
            return orderResource.get(shipmentJson.order.id)
                .then(function(orderJson) {
                    ...
                    return stockCardSummaryRepositoryImpl.query({
                        ...
                        .then(function(stockCardDetailMap) {
                            // #332: save shipment draft
                            return combineResponses(shipmentJson, orderJson.order, stockCardDetailMap);
                            // #332: ends here
                        });
                });
        }
