...
(function() {
    ...
    function routes($stateProvider) {
        $stateProvider.state('openlmis.locationManagement.locationDetailPrint', {
            url: '/locationDetailPrint',
            showInNavigation: false,
            views: {
                '@openlmis': {
                    controller: 'SiglusSohLocationDetailPrintController',
                    templateUrl: 'siglus-location-stock-on-hand/'
                    + 'siglus-soh-location-detail-print/siglus-soh-location-detail-print.html',
                    controllerAs: 'vm'
                }
            },
            resolve: {
