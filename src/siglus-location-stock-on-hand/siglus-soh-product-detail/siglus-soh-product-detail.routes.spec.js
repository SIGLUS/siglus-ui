...
describe('openlmis.locationManagement.stockOnHand.productDetail', function() {
    ...
    describe('stockCard resolve', function() {
        it('should return stockCard', function() {
            ...
            expect(siglusLocationStockOnHandService.getStockCardForProduct).toHaveBeenCalled();
        });
