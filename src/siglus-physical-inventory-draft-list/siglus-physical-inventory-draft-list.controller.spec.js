...
describe('siglusPhysicalInventoryDraftListController', function() {
    ...
    beforeEach(function() {
        ...
        draftList = [];
        programName = 'test';
        vm = $controller('siglusPhysicalInventoryDraftListController', {
            draftList: draftList,
    ...
    describe('clickActions', function() {
        ...
        it('should go to initialInventory page', function() {
            ...
            expect(this.$state.go).toHaveBeenCalledWith('openlmis.stockmanagement.initialInventory.draft', params);
        });
