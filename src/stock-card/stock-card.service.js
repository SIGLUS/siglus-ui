    ...
    function service($resource, $window, stockmanagementUrlFactory, accessTokenFactory, dateUtils) {
        ...
        var resource = $resource(
            stockmanagementUrlFactory('/api/siglusapi/stockCards/:stockCardId'), {}, {
                ...
                archiveProduct: {
                    url: stockmanagementUrlFactory('/api/siglusapi/archivedproducts/:orderableId/archive'),
                    method: 'POST'
                },
                activateProduct: {
                    url: stockmanagementUrlFactory('/api/siglusapi/archivedproducts/:orderableId/activate'),
                    method: 'POST'
                }
            }
        );
