...
(function() {
    ...
    function service() {
        ...
        this.setOrderableGroups = function(orderableGroups) {
            this.orderableGroups = orderableGroups;
        };

        this.findSelectedOrderableGroupsByOrderableId = function(orderableId) {
            var orderableGroups = this.orderableGroups;
