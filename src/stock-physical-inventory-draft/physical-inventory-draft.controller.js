...
(function() {
    ...
    function controller($scope, $state, $stateParams, addProductsModalService, messageService,
        ...
        vm.paginationId = 'stock-management-physical-inventory';
        ...
        vm.addProducts = function() {
            ...
            addProductsModalService.show(notYetAddedItems, vm.hasLot).then(function(addedItems) {
                ...
                // $stateParams.page = parseInt($state.params.page, 10);
        ...
        function hasDuplicateLotCode(lineItem, lots) {
            var allLots = lots ? lots : getAllLotCode();
        ...
        function getAllLotCode() {
            ...
            return draftLots.concat(vm.existLotCode);
        }
        // SIGLUS-REFACTOR: ends here
        ...
        function onInit() {
            ...
            $scope.$watchCollection(function() {
                ...
                vm.draft = draft;
                vm.displayLineItemsGroup = getDisplayLineItemsGroup();
                vm.updateProgress();
            });
        }

        function getDisplayLineItemsGroup() {
