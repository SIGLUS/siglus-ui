...
(function() {
    ...
    angular
        .module('stock-physical-inventory-print')
        .config(routes);

    routes.$inject = ['$stateProvider', 'STOCKMANAGEMENT_RIGHTS'];

    function routes($stateProvider, STOCKMANAGEMENT_RIGHTS) {
        $stateProvider.state('openlmis.stockmanagement.physicalInventory.print', {
            url: '/print?isInitialInventory&isMerged&draftNum&programId',
            views: {
                '@openlmis': {
                    controller: 'PhysicalInventoryPrintController',
                    templateUrl:
                   'stock-physical-inventory-print/' +
            ...
            resolve: {
                ...
                lineItemsGroup: function() {
                    return JSON.parse(localStorage.getItem('physicalInventoryCategories')) ;
                }
            }
